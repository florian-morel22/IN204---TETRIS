...
void Grid::set_case_value(unsigned int i, unsigned int j,
...
sf::RectangleShape Grid::get_case_value_drawn(unsigned int i,
                                              unsigned int j) const {
  return grid_drawn[i][j];
}

unsigned int **Grid::get_grid_num() const { return grid_num; };

sf::RectangleShape **Grid::get_grid_drawn() const { return grid_drawn; };

bool Grid::empty_case(unsigned int i, unsigned int j,
